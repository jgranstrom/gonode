...
Go.prototype.close = function() {
	...
	executeCommand(this, Signals.Termination, true);
}

/* Create and execute a command of JSON data
 */
Go.prototype.execute = function(data, callback) {
	executeCommand(this, new Command(nextCommandId++, data, callback));

}

/* Execute a command object */
function executeCommand(go, cmd, prioritized) {
	if(!prioritized) {
		// TODO check if queue command instead of directly executing
	}
