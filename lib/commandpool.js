...
function CommandPool(go) {
	...
	this.maxCommandsRunning = 10; // TODO: Make customizable
	this.commandTimeoutSeconds = 2; // TODO: Make customizable, has no effect yet
...
CommandPool.prototype.executeCommand = function(cmd, prioritized) {
	...
	if(!prioritized && this.runningCommands >= this.maxCommandsRunning) {
